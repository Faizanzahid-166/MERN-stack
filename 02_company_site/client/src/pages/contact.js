...
// ✅ RENAMED from src/pages/Contact.jsx  →  src/pages/contact.js  (serves "/contact")
// ✅ No react-router-dom imports
// ✅ @/ aliases used throughout
// ✅ sendContactForm already uses the fixed apiClient
...
import {
  ...
  AlertCircle, Loader2, Clock, MessageSquare,
} from 'lucide-react';
import PageWrapper           from '@/components/PageWrapper';
import { sendContactForm }   from '@/api/contactApi';

const contactInfo = [
  { icon: Mail,   label: 'Email',    value: 'blitztechhub@gmail.com', href: 'mailto:blitztechhub@gmail.com' },
...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Contact — Blitz Tech Hub</title>
        <meta
          name="description"
          content="Get in touch with Blitz Tech Hub. Start a project, request a quote, or just say hello — we respond within 24 hours."
        />
      </Head>
                  ...
                  <form onSubmit={handleSubmit} noValidate className="space-y-5">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={6}
                        className="w-full bg-[#0A0A0F] border border-[#1E1E3A] rounded-xl px-4 py-3 text-white placeholder-gray-600
                                   focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all text-sm resize-none"
                      />
                    </div>
