...
// ✅ RENAMED from src/pages/Services.jsx  →  src/pages/services.js  (serves "/services")
...
export default function Services() {
  return (
    <>
      <Head>
        <title>Services — Blitz Tech Hub</title>
        <meta
          name="description"
          content="Ten specialised digital services: web development, AI automation, SEO, digital marketing, app development, and more."
        />
      </Head>
...
// ─── Full-detail service card (services page only) ────────────────────────────
