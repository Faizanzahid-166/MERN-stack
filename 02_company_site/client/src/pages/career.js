// src/pages/career.js
// ✅ RENAMED from src/pages/Career.jsx  →  src/pages/career.js  (serves "/career")
// ✅ FIXED: API_BASE was undefined — now reads from process.env.NEXT_PUBLIC_*
// ✅ FIXED: fetch URL uses the correct env-aware base URL
...
// ✅ Resolve the correct API base at runtime (same logic as apiClient.js)
const API_BASE =
...
export default function Career() {
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      try {
        setLoading(true);
        // ✅ API_BASE is now properly defined from env vars above
  ...
  return (
    <>
      <Head>
        <title>Careers — Blitz Tech Hub</title>
        <meta
          name="description"
          content="Join the Blitz Tech Hub team. Remote-first, growth-focused roles in engineering, design, AI, marketing and more."
        />
      </Head>
      ...
      <PageWrapper>
        ...
        <section className="py-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Error / no-backend state */}
          {error && !loading && (
            <div className="glass-card p-8 text-center">
              <p className="text-gray-400 mb-2">
                Send your CV speculatively at{' '}
                <a href="mailto:blitztechhub@gmail.com" className="text-primary hover:underline">
                  blitztechhub@gmail.com
                </a>
              </p>
            </div>
          )}
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-2xl font-bold text-white mb-3">
                Don't see your role?{' '}
                <span className="gradient-text">Apply anyway.</span>
              </h2>
