...
// Fixed: replaced import.meta.env.DEV (Vite-only) with process.env.NODE_ENV check.
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 text-center bg-white dark:bg-gray-950">
        <div className="max-w-md">
          ...
          {/* Replaced import.meta.env.DEV with process.env.NODE_ENV */}
          ...
          <div className="flex gap-3 justify-center mt-8">
            <button onClick={this.handleReset} className="btn-brand">Go Home</button>
