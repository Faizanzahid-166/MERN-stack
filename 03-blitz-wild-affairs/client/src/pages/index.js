// src/pages/index.js
// ↳ Route: /
// Was: src/pages/Home.jsx — renamed to index.js, no other changes needed.
        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 py-28">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
              <span className="inline-flex items-center gap-2 bg-brand-100 dark:bg-brand-900/40 text-brand-600 text-sm font-semibold px-4 py-1.5 rounded-full mb-6">
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/blogs" className="btn-brand !text-base !px-8 !py-3.5 shadow-xl shadow-brand-500/20">
                  Explore Blogs →
                </Link>
      ...
      <section className="py-14 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mt-8">
          {CATEGORIES.map((cat, i) => (
            <motion.div key={cat.label} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}>
              <Link
                href={`/blogs?category=${cat.label}`}
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-900/40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-end justify-between mb-10">
              ...
              <Link href="/blogs?featured=true" className="text-sm text-brand-600 hover:text-brand-700 font-medium hidden sm:block">
                See all featured →
              </Link>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2">
            <div className="flex items-end justify-between mb-8">
              ...
              <Link href="/blogs" className="text-sm text-brand-600 hover:text-brand-700 font-medium">View all →</Link>
            </div>
