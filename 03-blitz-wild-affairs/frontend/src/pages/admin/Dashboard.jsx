  ...
  return (
    <div>
      ...
      <div className="flex gap-4 mb-10">
        ...
        <Link to="/admin/blogs" className="btn-ghost text-sm">Manage Posts</Link>
      </div>
          ...
          {loading ? (
            ...
            <div key={blog.id} className="px-6 py-4 flex items-center justify-between gap-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                ...
                <Link to={`/admin/blogs/edit/${blog.id}`} className="text-xs text-brand-600 hover:underline">Edit</Link>
              </div>
            </div>
          ))}
        </div>
